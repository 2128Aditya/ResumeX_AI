# Developed by Aditya singh [https://https://github.com/2128Aditya]    Made with Streamlit
...
st.set_page_config(
   page_title="AI Resume Analyzer - Aditya singh",
...
def run():
    ...
    with nav:
        ...
        with col1:
            st.markdown("<div class='nav-title'>⚡ ResumeX AI</div>", unsafe_allow_html=True)
    ...
    <div class="hero">
        ...
        <p>Analyze your resume instantly with AI, get score, insights & job-ready suggestions</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    <div class="footer">
        ...
        <a href="https://aditya-portfolio-v2-aoz4.vercel.app/" target="_blank" style="color:#60A5FA;">Visit Portfolio</a>
    </div>
    """, unsafe_allow_html=True)
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        st.markdown("## 🚀 About ResumeX AI")

        st.markdown("""
        **ResumeX AI** ek AI-powered tool hai jo aapke resume ko analyze karta hai 
        aur aapko better career opportunities ke liye guide karta hai.

        Ye system **Natural Language Processing (NLP)** aur **Machine Learning** ka use karke 
        resume se important information extract karta hai aur smart suggestions deta hai.
        """)
        ...
        st.markdown("""
        1. 👤 Fill your basic detail  
        2. 📤 Upload your resume (PDF format)  
        3. ⚡ System  analyzing automatic 
        4. 📈 You will get scores, skills and suggestions  
        """)
        ...
        **Aditya Singh**  
        ...
        st.success("🚀 Build your resume smarter & land your dream job!")  
        ...
        if st.button('Login'):
            ...
            ## Credentials 
            if ad_user == 'aadi' and ad_password == 'Aditya@2128':
                ...
                st.success("Welcome Aditya! 👋 Total %d " % values + " users have used the AI Resume Analyzer ✨")                
